...
{
#if RETRO_PLATFORM == RETRO_KALLISTIOS
    sprintf_s(streamFilePath, sizeof(streamFilePath), "%sData/Music/%s", KOS_USER_DIR, filename);
...
#if RETRO_PLATFORM == RETRO_KALLISTIOS
    sprintf_s(fullFilePath, sizeof(fullFilePath), "%sData/SoundFX/%s", KOS_USER_DIR, filename);
