...
#define KOS_ATLAS_WIDTH_TILES (32)
#define KOS_ATLAS_HEIGHT_TILES (32)
#define KOS_ATLAS_WIDTH_PIXELS (512)
#define KOS_ATLAS_HEIGHT_PIXELS (512)
#define KOS_ATLAS_LINE_SIZE_SHIFT (9)
#endif
